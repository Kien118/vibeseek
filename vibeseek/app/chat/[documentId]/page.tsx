...
export default async function ChatPage({ params }: Props) {
  ...
  return (
    <main className="max-w-3xl mx-auto p-4 space-y-4">
      <Link href="/dashboard" className="inline-block text-sm text-sunflower underline">← Về Dashboard</Link>
      <h1 className="text-2xl font-bold text-paper-cream">💬 Chat với DOJO</h1>
