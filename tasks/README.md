...
Phase 2 — **Quiz + Leaderboard** — 🚧 in progress (Batch A done, Batch B next)
...
- [T-204 Quiz + Leaderboard API routes (lazy generate + submit + top-N)](./T-204-quiz-leaderboard-api.md) — HIGH, next
...
- Batch B (once Batch A done): **T-204** (needs all of A) — 🚧 next
