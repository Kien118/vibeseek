...
- [T-303 `lib/ai/chat.ts` RAG retrieval + streaming wrapper + RPC](./T-303-chat-lib-rag-streaming.md) — ✅ done (PR #25, merge `7e7ea3a`)
- [T-304 `POST /api/chat` SSE route](./T-304-chat-sse-api-route.md) — ✅ done (PR #26, merge `1c023f7`)
